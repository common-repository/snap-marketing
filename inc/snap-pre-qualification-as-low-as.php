...
if ( $response->status != 200 ) {
	...
	if ( $response->success ) {
		...
		<p>
			...
			?>
			<a class="learn-more-popup" onclick="snap.launch({ experience: 'PRE_QUALIFICATION', token: '<?php echo esc_attr($Snap_Token) ?>', marketing: { treatment: 'PRE_QUALIFICATION' } });return false;" href="#marketing-prequalify-modal">
				<?php _e( 'Prequalify now!', 'snap-marketing' ); ?>
			</a>
		</p>
		<!-- white-popup-block mfp-hide -->
		<div id="marketing-prequalify-modal" class="marketing-modal">
			<div class="marketing-modal-wrapper">
				...
				<div class="snap-content-area">
					...
					onclick="snap.launch({ experience: 'PRE_QUALIFICATION', token: '<?php echo esc_html( $Snap_Token ); ?>', marketing: { treatment: 'PRE_QUALIFICATION' } });return false;"><?php _e( 'Learn More', 'snap-marketing' ); ?></a>
					<?php
